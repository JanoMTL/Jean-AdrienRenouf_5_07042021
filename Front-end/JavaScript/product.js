...
function displayArticles(article) {
  ...
  cloneElement.getElementById("camera__description").textContent =
    article.description;
  cloneElement.getElementById("camera__img").src = article.imageUrl;
  cloneElement.getElementById("camera__price").textContent =
    article.price / 100 + " €";
  ...
  btnAdd.addEventListener("click", () => {
    ...
    const cameraLens = document.getElementById("lens_select")[
      selector.selectedIndex
    ].id;
    const cameraQuantity = document.getElementById("Quantity")[
      selector1.selectedIndex
    ].id;
    ...
    function updateDiv() {
      document.getElementById("ArtNumber").innerText = document.getElementById(
        "ArtNumber"
      ).innerText;
    }
